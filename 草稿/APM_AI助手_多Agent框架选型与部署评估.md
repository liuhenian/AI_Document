# 1 APM AI 助手 — 多 Agent 框架选型与本地部署评估
...
#### 1.3.2.4 D10：自定义 Tool 开发难度（高频工作）
...
#### 1.5.3.3 学习曲线对比（针对 AI 基础弱的 Python 团队）
...
#### 1.6.2.2 🥈 备选方案：Dify + LangGraph 混合
...
#### 1.7.2.3 WP-3：5 个数据源 Tool 开发（核心工作）
